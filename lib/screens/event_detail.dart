                    ...
                    slivers: <Widget>[
                      new SliverAppBar(
                        ...
                        flexibleSpace: new FlexibleSpaceBar(
                          centerTitle: true,
                          title: new Text("Detalhes do Evento", textAlign: TextAlign.center),
                              ...
                              new Container(
                                ...
                                decoration: new BoxDecoration(
                                  image: DecorationImage(
                                    image: NetworkImage(event.imagens[0].imagemEncoded)
                                  ),
                                ),
                              ),
                            ],
                                        ...
                                        new Row(
                                          children: <Widget>[
                                            ...
                                            new Padding(
                                              ...
                                              child: new Text(_dateFormat.format(DateTime.parse(event.data))),
                                            ),
                                        ...
                                        new Row(
                                          children: <Widget>[
                                            ...
                                            new Padding(
                                              ...
                                              const EdgeInsets.all(8.0),
                                              child: Text(
                                                  "${event.localizacao.cidade}, \n\n${event.localizacao.bairro} ${event.localizacao.estado}"),),
