...
class SearchSalesScreen extends StatefulWidget {
  ...
  SearchSalesScreen(this._userInfo);
  @override
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (snapshot.data.length == 0) {
                            ...
                            _salesBloc.getSearchListSales(endOfTheList, null,
                                _radioValue1, editingController.text, false);
                            return Container(
                                height: 40,
                                width: 40,
